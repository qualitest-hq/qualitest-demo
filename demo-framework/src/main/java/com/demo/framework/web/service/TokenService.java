...
public class TokenService {
    ...
    public LoginUser getLoginUser(HttpServletRequest request) {
        ...
        if (StringUtils.isNotEmpty(token)) {
            try {
                ...
                Object loginType = claims.get(Constants.JWT_LOGIN_TYPE);
                if (Constants.LOGIN_TYPE_ACCOUNT.equals(String.valueOf(loginType))) {
                    return null;
                }
                // 解析对应的权限以及用户信息
    ...
    public String createToken(LoginUser loginUser) {
        ...
        claims.put(Constants.JWT_LOGIN_TYPE, Constants.LOGIN_TYPE_ADMIN);
    ...
    /**
     * 解析请求中的 JWT loginType
     */
    public String resolveLoginType(HttpServletRequest request) {
        ...
        try {
            ...
            Object loginType = claims.get(Constants.JWT_LOGIN_TYPE);
            if (loginType == null) {
                return Constants.LOGIN_TYPE_ADMIN;
            }
            return String.valueOf(loginType);
        } catch (Exception e) {
            log.error("解析登录类型异常'{}'", e.getMessage());
            return null;
        }
    }
