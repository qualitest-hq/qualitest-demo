-- ============================================================================
-- 【失败场景 F08】并行退款拦截
-- 对应 §10 场景 14：已有 refund_status∈{0,1,3} 的退款单 → 再次 apply 失败
-- 前置: reset_test_data.bat
-- 预期: 订单 7005 再次 POST refund/apply → code≠200
-- ============================================================================
...
(7005, 'MO2026062110300001', 30001, 5, 99.00, 0.00, 0, '', 0.00, 0.00, 0.00, 0.00, 99.00, 0, '张三', '13800000001', '广东省深圳市南山区科技园南路1号', 'seed退款中', '', NULL, NULL, NULL, 'PAY20260621103001', 3, 1, 'TX20260621103001', '2026-06-21 10:30:00', 0.00, 3, 0, 0, '2026-06-21 10:29:00', '2026-06-21 10:31:00', 'F08');
...
(9002, 'RF2026062110310001', 7005, 30001, 1, 99.00, 0, '并行退款测试', '', '2026-06-21 10:31:00', NULL, NULL, '', 0, '2026-06-21 10:31:00', '2026-06-21 10:31:00', 'F08');
