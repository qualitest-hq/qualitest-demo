...
public interface IMallOrderItemService {
     ...
     * @return 结果
     */
    int deleteMallOrderItemByIdList(List<Long> orderItemIdList);
     ...
     * 批量修改商城订单明细为逻辑删除
     *
     * @param orderItemIdList 商城订单明细ID集合
     * @return 结果
     */
    int logicDeleteMallOrderItemByIdList(List<Long> orderItemIdList);
