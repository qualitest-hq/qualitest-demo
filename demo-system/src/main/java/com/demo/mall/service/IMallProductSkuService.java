...
public interface IMallProductSkuService {
     ...
     * @return 结果
     */
    int deleteMallProductSkuByIdList(List<Long> skuIdList);
     ...
     * 批量修改商城商品SKU为逻辑删除
     *
     * @param skuIdList 商城商品SKUID集合
     * @return 结果
     */
    int logicDeleteMallProductSkuByIdList(List<Long> skuIdList);
